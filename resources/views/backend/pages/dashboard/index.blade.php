...
{{-- @include('backend.layouts.partial.title_area') --}}
<!-- page title area end -->
...
<div class="main-content-inner">
    <div class="row">
        ...
        <!-- seo fact area start -->
        {{-- @include('backend.layouts.partial.fact_area') --}}
        ...
        {{-- @include('backend.layouts.partial.campain_area') --}}
        ...
        {{-- @include('backend.layouts.partial.statistics_area') --}}
        ...
        {{-- @include('backend.layouts.partial.advertising_area') --}}
        <div class="col-lg-4 mt-5">
        ...
        <!-- sales area start -->
        {{-- @include('backend.layouts.partial.sales_area')--}}
        ...
        <!-- timeline area start -->
        {{-- @include('backend.layouts.partial.timeline_area') --}}
        ...
        <!-- map area start -->
        {{-- @include('backend.layouts.partial.map_area') --}}
        ...
        {{-- @include('backend.layouts.partial.testmonial_area')--}}
